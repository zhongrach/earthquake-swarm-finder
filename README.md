...
## Swarm Finder
 The `swarms` module contains the function `find_swarms()`, which groups earthquakes into swarms based on three criteria set by the user:
...
**Source:**
 U.S. Geological Survey (USGS) (2024). Earthquake hazards program (EHP). Available online at: https://earthquake.usgs.gov/earthquakes (Accessed September 10, 2024)
