...
## Inputs
 Earthquake data from the United States Geological Survey. Earthquakes occur between 2000-01-01 and 2024-09-01 and within 50 km of the Mid-Atlantic Ridge. The four files correspond to four sections of the Mid-Atlantic Ridge: Reykjanes Ridge (52.27 N to 63 N), Northern MAR (15 N to 52.27 N), Central MAR (2 S to 15 N), and Southern MAR (55 S to 2 S) indicated by the letters 'r', 'n', 'c', and 's', respectively.
